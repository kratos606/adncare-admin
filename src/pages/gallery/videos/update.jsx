...
const UpdateGalleryVideo = () => {
  ...
  const fetchVideoData = async () => {
    try {
      const response = await axios.get(`${BaseURL}/galerie-video/${id}`, {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${BaseURL}/galerie-video/${id}`, formData, {
        headers: {
...
export default UpdateGalleryVideo;