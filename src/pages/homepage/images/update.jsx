...
const UpdateImage = () => {
  ...
  const fetchImageData = async () => {
    try {
      ...
      setSlider(data.slider); // Set the slider value from the fetched data
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${BaseURL}/images/${id}`, formData, {
        headers: {
    ...
    <Box sx={{ p: 3 }}>
      ...
      >
        ...
        <FormControl fullWidth required>
          <InputLabel id="slider-label">Slider Type</InputLabel>
          <Select
          ...
          >
            <MenuItem value={1}>Slider 1</MenuItem>
            <MenuItem value={2}>Slider 2</MenuItem>
          </Select>
        </FormControl>
